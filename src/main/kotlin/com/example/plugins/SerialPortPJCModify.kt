...
class SerialPortPJCModify(sp: SerialParameters?) : SerialPort(sp), SerialPortEventListener {
    private var port: purejavacomm.SerialPort? = null
    ...
    override fun open() {
        try {
            ...
            if (portIdentifier.isCurrentlyOwned) {
                ...
                if (commPort is purejavacomm.SerialPort) {
                    port = commPort
